...
/**
 * @title NikosGame
 * @dev Betting token for Nikos Game
 */
contract NikosGame is Ownable, ERC20 {
    ...
    constructor() ERC20("Nikos Game Betting Token", "NGBT", 8) {
        if (isGoerli()) {
    ...
    function sellCollectedTaxes() internal lockTheSwap {
        // Of the remaining tokens, set aside 1/2 of the tokens to LP,
        // swap the rest for ETH. LP the tokens with all of the ETH
        // (only enough ETH will be used to pair with the original 1/2
